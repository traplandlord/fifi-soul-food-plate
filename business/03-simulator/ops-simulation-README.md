...
## Product-drop flywheel (primary demand sim)

The **50-plate** flyer line is **marketing scarcity**. Primary demand model is now the **Jordan/iPhone-style product-drop + marketplace flywheel**:

- `ops-simulation-flywheel-demand.csv` / `03-simulator/` — **week-for-week** simulator (scroll 1→52)
- `ops-simulation-flywheel-README.md`
- `generate_flywheel_sim.py`
- Investor deck: `investor/Fifi-Soul-Food-Plate-Investor-Deck.pptx`

This location-vs-mobile CSV remains a period snapshot companion.
